	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			<div class="col-md-12 cart-table">
				...
				<div class="col-md-12">
					<div class="col-md-2">
						<img src="/images/d1.jpg" class="img-thumbnail img-responsive" />
					</div>
					<div class="col-md-5 ">
						<h4 class="product">Product Name</h4>
						<br />Price
					</div>
					<div class="col-md-2 col-md-offset-1" style="margin-top: -1em;">
						<div class="remove">
							<button class="btn btn-danger">&times</button>
						</div>
					</div>
					<div class="col-md-2 add-to-cart" style="margin-top: -10px;">

						<div class="box btn btn-success">ADD TO CART</div>
						<!-- <form action="#" method="post">
																<fieldset>
				...
				<div class="col-md-6 col-md-offset-3 cart-box" id="wishlist-box">
					...
					<div style="margin-top: 2em;">REMOVED FROM WISHLIST</div>
				</div>
				<!-- //add-to-wishlist -->
				<div class="clearfix"></div>			
			</div>
