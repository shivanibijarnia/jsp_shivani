		...
		<div class="container">
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				...
				<div style="margin-bottom: 1em;">
					<span> 
						<i class="fa fa-star" aria-hidden="true" style="color: #2fdab8;font-size: x-large;"></i>
						<i class="fa fa-star" aria-hidden="true" style="color: #2fdab8;font-size: x-large;"></i>
						<i class="fa fa-star" aria-hidden="true" style="color: #2fdab8;font-size: x-large;"></i>
						<i class="fa fa-star" aria-hidden="true" style="color: #2fdab8;font-size: x-large;"></i>
						<i class="fa fa-star" aria-hidden="true" style="color: #2fdab8;font-size: x-large;"></i>						
				...
				<div class="color-quality">
					<div class="color-quality-right col-md-5"  style="border-radius: 3em;background: #272727;color: white;font-size: 1.1em;margin-bottom: 1em;">
						<div class="col-md-1 inc button quantity" style="float:  left;margin-left: -0.7em;padding-right: 2em;">+</div>
						<div class="col-md-7" style="text-align: center;" id="quantity">Quantity</div>
						<div class="col-md-1 dec button quantity" style="float:  right;margin-right: -0.7em;padding-left: 2em;">-</div>
						<div class="clearfix"></div>
					</div>
				</div>
									...
									<div class="add-review">
										...
										<form action="#" method="post">
											<input type="text" name="Name" required="Name"
												placeholder="Enter Name"> <input type="email"
												name="Email" required="Email" placeholder="Enter Email">
											<textarea name="Message" required=""
												placeholder="Enter Feedback"></textarea>
											<h4>rating</h4>
											<div class="rating1" style="padding: 1em 0em;">
												<span class="starRating"> <input id="rating5"
													...
													name="rating" value="4"> <label for="rating4">4</label>
													<input id="rating3" type="radio" name="rating" value="3"
													checked=""> <label for="rating3">3</label> <input
			...
			<div class="w3_agile_latest_arrivals">
				...
				<div class="col-md-3 product-men single">
					<div class="men-pro-item simpleCart_shelfItem">
						...
						<div class="item-info-product ">
							...
							<div
								class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2 s-add-to-cart">
								<div class="box">ADD TO CART</div>
							</div>
							<div
								class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2 s-add-to-wishlist">
								<div class="box">ADD TO WISHLIST</div>
							</div>
						</div>
					</div>
				...
				<!-- /add-to-cart -->
					<div class="col-md-6 col-md-offset-3 s-cart-box" id="s-cart-box">
						<div style="font-size: 1.5em;float: right;cursor: pointer;" id="s-close-cart">&times</div>
						<div style="margin-top: 2em;">ADDED TO CART</div>
					</div>
					<!-- //add-to-cart -->
					<!-- /add-to-wishlist -->
					<div class="col-md-6 col-md-offset-3 s-cart-box" id="s-wishlist-box">
						<div style="font-size: 1.5em;float: right;cursor: pointer;" id="s-close-wishlist">&times</div>
						<div style="margin-top: 2em;">ADDED TO WISHLIST</div>
					</div>
					<!-- //add-to-wishlist -->
				<div class="clearfix"></div>
