		...
		<div class="container">
			<div class="col-md-12 cart-table">
					...
					<tbody>
						<tr>
							...
							<td class="col-md-8 "><h4 class="product">Product Name</h4>
								<br />Price <br/>
								<div class="col-md-3" style="margin-top:  2em;background: #000000c7;border-radius: 1em;color: white;font-weight:  bold;">
									<div class="col-md-1 inc button quantity"
										style="float: left; margin-left: -0.7em; padding-right: 2em;">+</div>
									<div class="col-md-1" style="text-align: center;" id="quantity">0</div>
									<div class="col-md-1 dec button quantity"
										style="float: right; margin-right: -0.7em; padding-left: 2em;">-</div>
									<div class="clearfix"></div>
								</div>
							</td>
				...
				<div class="col-md-6 col-md-offset-3 cart-box" id="cart-box">
					...
					<div style="margin-top: 2em;">REMOVED FROM CART</div>
				</div>
				<!-- //add-to-cart -->
				<div class="col-md-4">
					<h4 class="product">Total: $100</h4>
				</div>
				<div class="col-md-2 col-md-offset-5 btn btn-danger">Place
					Order</div>
			</div>
		</div>
	</div>
