...
<body>
			...
			<ul>
				<li style="line-height: 3.5em; font-size: 1.1em; cursor: pointer;"><div
						...
						<ul class="dropdown-menu" style="background: black;">
							<li style="width: 100%; border-right: black;"><a href="#"
								style="font-size: larger;">Change Password</a></li>
							<li style="width: 100%; border-right: black;"><a href="#"
								style="font-size: larger;">My Orders</a></li>
							<li style="width: 100%; border-right: black;"><a href="#"
								style="font-size: larger;">My Wishlist</a></li>
							<li style="width: 100%; border-right: black;"><a href="#"
								style="font-size: larger;">Logout</a></li>
						</ul>
					</div></li>
	...
	<div class="banner-bootom-w3-agileits">
		<form action="forget-pwd-email" method="post" onsubmit="return validate()">
		<div class="container">
			<div class="col-md-6 col-md-offset-3 cart-table">
				<div class="col-md-12"><div class="col-md-4">New Password</div>
				<div class="col-md-6"><input type="password" name="ques" value="" id="pwd" style="color: black;"/></div></div>
				<div class="col-md-12" style="margin-top: 0.5em;"><div class="col-md-4">Confirm Password</div>
				<div class="col-md-6"><input type="password" name="ans" value="" id="cpwd" style="color: black;"/></div></div>
				<div class="col-md-2" style="margin-top: 4em;float:  right;"><input type="submit" class="btn btn-primary" value="Submit"></div>
			</div>
		</div>
		</form>
	</div>
