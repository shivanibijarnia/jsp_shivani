	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="container">
			<div class="col-md-6 col-md-offset-3 cart-table">
				<div class="col-md-12"><div class="col-md-4">Question</div>
				<div class="col-md-6"><input type="text" name="ques" value="Hey Buddy" id="ques" style="color: black;"/></div></div>
				<div class="col-md-12" style="margin-top: 0.5em;"><div class="col-md-4">Answer</div>
				<div class="col-md-6"><input type="text" name="ans" value="" id="ans" style="color: black;"/></div></div>
